...
export default tool({
  ...
  args: {
    ...
    includeSitemap: tool.schema
      .boolean()
      .optional()
      .describe("Use sitemap to discover pages (default: true)"),
    outputFormat: tool.schema
      .enum(["json", "markdown", "terminal"])
      .optional()
      .describe("Output format: json, markdown, or terminal (default: json)"),
    serve: tool.schema
      .boolean()
      .optional()
      .describe("Serve interactive HTML report locally (default: false)"),
    outputPath: tool.schema
      .string()
      .optional()
      .describe("Save report to file path"),
  },
  async execute(args) {
